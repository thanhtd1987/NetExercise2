...
namespace NetExercise.Test.OPP
{
    public class Linq01Test
    {
        ...
        [TestCase("14/5")]
        public void Test_GetMax_Ok(string text)
        {
            var linq1 = new ExerciseLinq01(InitList);

            var max = linq1.GetMax();

            Assert.AreEqual(max.ToString(), text);
        }

        [TestCase("4/15")]
        public void Test_GetMin_Ok(string text)
        {
            var linq1 = new ExerciseLinq01(InitList);

            var min = linq1.GetMin();

            Assert.AreEqual(min.ToString(), text);
        }

        [TestCase("5/2")]
        public void Test_GetSum_Ok(string text)
        {
        ...
        [TestCase("3/8")]
        public void Test_GetMultiply_Ok(string text)
        {
            var linq1 = new ExerciseLinq01(new List<Fraction> {
                new Fraction(1,2),
                new Fraction(4,8),
        ...
        public void Test_SortByValue_Ok(string text)
        {
            ...
            Assert.AreEqual(resText, text);
        }
        
        [TestCase("1/2,3/2,4/7,5/10")]
        public void Test_SortByAValue_Ok(string text)
        {
            var linq1 = new ExerciseLinq01(ShortList);
        ...
        public void Test_SortByBValueDescending_Ok(string text)
        {
            var linq1 = new ExerciseLinq01(ShortList);
        ...
        [TestCase("1/2")]
        public void Test_GetDuplicatedByEqual_Ok(string text) {
            var linq1 = new ExerciseLinq01(new List<Fraction> {
                new Fraction(1,2),
                new Fraction(4,8),
                new Fraction(3,2),
        ...
        public void Test_GetDuplicatedBySameValue_Ok(string text) {
            var linq1 = new ExerciseLinq01(new List<Fraction> {
                new Fraction(1,2),
                new Fraction(4,8),
                new Fraction(3,2),
        ...
        [TestCase(1)]
        public void Test_CountByBValueGreater_Ok(int text) {
            var linq1 = new ExerciseLinq01(new List<Fraction> {
                new Fraction(1,2),
                new Fraction(4,8),
                new Fraction(3,2),
        ...
        [TestCase("1/2,3/2")]
        public void Test_GetDistinctByFractionValue_Ok(string text) {
            var linq1 = new ExerciseLinq01(new List<Fraction> {
                new Fraction(1,2),
                new Fraction(4,8),
                new Fraction(3,2),
